...
exports.checkout = exports.clear = exports.remove = exports.update = exports.add = exports.getAll = void 0;
const response_format_1 = require("../../utils/response-format");
const client_1 = require("../../prisma/client");
const cart_validator_1 = require("../../validators/user/cart-validator");
...
const checkout = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
        const items = yield (0, cart_validator_1.checkoutValidator)(user.id);
